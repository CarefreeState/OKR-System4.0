...
//                        AutolinkExtension.create(),
                        AnchorLinkExtension.create(), AsideExtension.create(), AdmonitionExtension.create(),
                        GfmIssuesExtension.create(), GfmUsersExtension.create(), GitLabExtension.create(),
                        SuperscriptExtension.create(), StrikethroughSubscriptExtension.create(), FootnoteExtension.create(),
                        TaskListExtension.create(), InsExtension.create(), TypographicExtension.create(),
                        DefinitionExtension.create(), AbbreviationExtension.create(), ResizableImageExtension.create(),
                        MediaTagsExtension.create(), EmojiExtension.create(), WikiLinkExtension.create(),
