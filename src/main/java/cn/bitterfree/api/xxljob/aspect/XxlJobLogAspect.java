package cn.bitterfree.api.xxljob.aspect;
...
public class XxlJobLogAspect {
    ...
    @Pointcut("execution(* cn.bitterfree.api..*.*(..)) && @annotation(cn.bitterfree.api.xxljob.annotation.XxlRegister) && @annotation(com.xxl.job.core.handler.annotation.XxlJob)")
    public void runJob() {}
