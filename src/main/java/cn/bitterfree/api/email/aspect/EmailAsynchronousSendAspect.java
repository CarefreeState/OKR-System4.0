package cn.bitterfree.api.email.aspect;

import cn.bitterfree.api.common.exception.GlobalServiceException;
import cn.bitterfree.api.common.util.juc.threadpool.ThreadPoolUtil;
...
public class EmailAsynchronousSendAspect {
    ...
    @Pointcut("execution(* cn.bitterfree.api.email.sender.EmailSender.*(..))")
    public void send() {}
