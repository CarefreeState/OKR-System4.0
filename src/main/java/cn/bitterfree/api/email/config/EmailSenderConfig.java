package cn.bitterfree.api.email.config;
...
import cn.bitterfree.api.email.provider.strategy.ProvideStrategy;
import cn.bitterfree.api.email.provider.strategy.RoundRobinProvideStrategy;
import lombok.Data;
