...
import cn.bitterfree.api.common.config.ResourceCompressionConfig;
import cn.bitterfree.api.common.enums.FileResourceType;
...
public final class FileMediaServiceImpl implements FileMediaService {
    ...
    public String uploadFile(MultipartFile file) {
        return uploadFile(file, FileMediaConstants.DEFAULT_ACTIVE_LIMIT);
    }
    ...
    public String uploadFile(String originalName, byte[] data) {
        return uploadFile(originalName, data, FileMediaConstants.DEFAULT_ACTIVE_LIMIT);
    }
    ...
    public String uploadImage(MultipartFile file) {
        return uploadImage(file, FileMediaConstants.DEFAULT_ACTIVE_LIMIT);
    }
    ...
    public String uploadImage(String originalName, byte[] data) {
        return uploadImage(originalName, data, FileMediaConstants.DEFAULT_ACTIVE_LIMIT);
    }
