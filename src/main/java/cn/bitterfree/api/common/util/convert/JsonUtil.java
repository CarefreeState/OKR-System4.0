...
public class JsonUtil {
    ...
    static {
        OBJECT_MAPPER = new Jackson2ObjectMapperBuilder()
                ...
                .simpleDateFormat(DateTimeConstants.DATE_TIME_PATTERN)
                .serializers(new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(DateTimeConstants.DATE_TIME_PATTERN)))
                .serializers(new LocalDateSerializer(DateTimeFormatter.ofPattern(DateTimeConstants.DATE_PATTERN)))
                .deserializers(new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(DateTimeConstants.DATE_TIME_PATTERN)))
                .deserializers(new LocalDateDeserializer(DateTimeFormatter.ofPattern(DateTimeConstants.DATE_PATTERN)))
