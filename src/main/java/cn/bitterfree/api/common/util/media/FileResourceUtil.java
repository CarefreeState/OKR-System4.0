...
public class FileResourceUtil {
    ...
    public static boolean isImage(String contentType) {
        return matchType(contentType, FileResourceType.IMAGE);
    }

    public static void checkImage(String contentType) {
        checkType(contentType, FileResourceType.IMAGE);
    }

    public static boolean isVideo(String contentType) {
        return matchType(contentType, FileResourceType.VIDEO);
    }

    public static void checkVideo(String contentType) {
        checkType(contentType, FileResourceType.VIDEO);
    }

    public static boolean isText(String contentType) {
        return matchType(contentType, FileResourceType.TEXT);
    }

    public static void checkText(String contentType) {
        checkType(contentType, FileResourceType.TEXT);
    }
