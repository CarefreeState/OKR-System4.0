package cn.lbcmmszdntnt.domain.record.constants;
...
public interface DayRecordConstants {
    ...
    String FIRST_QUADRANT_RECORD = "credit1";
    String SECOND_QUADRANT_RECORD = "credit2";
    String THIRD_QUADRANT_RECORD = "credit3";
    String FOURTH_QUADRANT_RECORD = "credit4";
