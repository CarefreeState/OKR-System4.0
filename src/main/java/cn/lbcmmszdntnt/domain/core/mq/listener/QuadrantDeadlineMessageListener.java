package cn.lbcmmszdntnt.domain.core.mq.listener;
...
import cn.lbcmmszdntnt.domain.core.mq.config.DelayExchangeConfig;
...
public class QuadrantDeadlineMessageListener {
    ...
    @RabbitListener(queues = DelayExchangeConfig.FIRST_QUADRANT_DDL_QUEUE)
    ...
    @RabbitListener(queues = DelayExchangeConfig.SECOND_QUADRANT_DDL_QUEUE)
    ...
    @RabbitListener(queues = DelayExchangeConfig.THIRD_QUADRANT_DDL_QUEUE)
